class User < ActiveRecord::Base
  ...
  attr_accessible :username, :email, :password, :password_confirmation, :photo, :commentaire, :groupe_id, :fonction, :date_arrivee

  attr_accessor :password
  before_save :prepare_password

  belongs_to :groupe
  belongs_to :immeubles
  has_many :dossiers, :through => :immeubles
